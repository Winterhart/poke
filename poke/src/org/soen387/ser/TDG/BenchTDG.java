...
public class BenchTDG {
	private static final String tableName = "bench";
	...
	private final static String CREATE_TABLE = 
			...
			"CONSTRAINT FK_BENCH_cardId "
			+ "FOREIGN KEY (cardId) REFERENCES card(id) "
			+ "ON DELETE CASCADE " 
			+ "ON UPDATE CASCADE, " +
			"CONSTRAINT FK_BENCH_deckId "
			+ "FOREIGN KEY (deckId) REFERENCES deck(id) "
			+ "ON DELETE CASCADE " 
			+ "ON UPDATE CASCADE, " +
			"CONSTRAINT FK_BENCH_gameId FOREIGN KEY (gameId) REFERENCES game(id) "
			+ "ON DELETE CASCADE "
